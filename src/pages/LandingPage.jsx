          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight mb-6 tracking-tight">
                Jangan Biarkan CV Anda{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">
                  Gugur di Tahap ATS.
                </span>
              </h1>
              <p className="text-lg text-slate-500 mb-8 leading-relaxed max-w-xl">
                Platform <strong>Job Matching Berbasis AI</strong> yang
                membimbing pencari kerja menutupi <em>skill gap</em> mereka,
                sekaligus membantu perusahaan menyaring kandidat terbaik dalam
                hitungan detik.
              </p>
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                ...
                <Link
                  to="/login"
                  className="px-6 py-3.5 bg-white border border-slate-200 text-slate-700 text-sm font-bold rounded-xl hover:bg-slate-50 transition shadow-sm text-center flex items-center justify-center group"
                >
                  <i className="fas fa-building mr-2 text-slate-400 group-hover:text-blue-500 transition"></i>{" "}
                  Saya Perusahaan (HRD)
                </Link>
              </div>
            </div>
            ...
            <div className="relative lg:ml-10">
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-6 relative z-10 flex flex-col space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-[11px] font-bold text-slate-500 uppercase pt-2">
                    Deteksi Gap (Missing)
                  </p>
                  <div className="flex gap-2">
                    <span className="px-2 py-1 bg-rose-50 text-rose-700 text-xs font-bold rounded border border-rose-100">
                      TypeScript
                    </span>
                  </div>
                  <div className="mt-4 p-3 bg-slate-50 rounded-lg border border-slate-100 flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500">
                        Tutup gap Anda dengan modul ini.
                      </p>
                    </div>
              ...
              <div
                className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-lg border border-slate-100 p-4 z-20 flex items-center space-x-3 animate-bounce"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">
              Solusi End-to-End untuk Ekosistem Karir
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto">
              Dirancang khusus untuk mendukung Digitalisasi Penciptaan Lapangan
              Kerja di Indonesia.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Algoritma NLP dan Cosine Similarity mencocokkan profil pelamar
                dengan deskripsi pekerjaan secara semantik, bukan sekadar
                keyword biasa.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Memberikan umpan balik transparan kepada pelamar mengenai
                keterampilan apa yang kurang agar mereka tidak mengulang
                kesalahan.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Secara otomatis merekomendasikan kursus atau sertifikasi dari
                mitra untuk menutupi celah keahlian secara instan.
              </p>
            </div>
          </div>
        </div>
